...
public class BerandaFragment extends Fragment implements OnCardClickBeranda {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        private void setListener() {
            main_FAB_addButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(getActivity().getApplication(), TambahDataActivity.class);
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                JSONArray jsonLembur = response.getJSONArray("barang");
        ...
        public void onCardClick(int position) {
            ...
            Intent intent = new Intent(getActivity().getApplication(), DetaildataActivity.class);
